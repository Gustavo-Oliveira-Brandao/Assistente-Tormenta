...
Esse projeto é feito com Electron Vite, React, TypeORM e SQLite, fazendo uso de versões anteriores por questões de compatibilidade.
...
```bash
git clone https://github.com/Gustavo-Oliveira-Brandao/Arquivos-de-Tanna-Toh
```

### Instale as dependências através da pasta raiz do projeto
