...
export const ManaForm = ({ mana }: { mana: IRecurso }): JSX.Element => {
  ...
  const methods = useForm<z.infer<typeof recursoSchema>>({
    ...
    defaultValues: recursoSchema.parse(mana)
  })
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onEdit)}>
        <fieldset>
          <legend>Mana atual</legend>
          <div className="d-flex">
            <FormGroup
              name="valorAtual"
              label={`atual:`}
              placeholder={String(mana.valorAtual)}
              type="number"
            />
            <FormGroup
              name="valorTemporario"
              label={`temp:`}
              placeholder={String(mana.valorTemporario)}
              type="number"
            />
          </div>
        </fieldset>
        <fieldset>
          <legend>Mana maxima</legend>
          <div className="d-flex">
            <FormGroup
              name="atributo"
              label="atributo:"
        ...
        <fieldset>
          <legend>Modificadores de Mana maxima</legend>
