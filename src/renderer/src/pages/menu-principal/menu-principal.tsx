        ...
        <div className={styles.footer}>
          <div className={styles.botoes}>
            <Button
              ...
              onClick={() => setSelecaoPersonagensEstaAberta(true)}
            >
              <p className="tormenta20Font">Personagens</p>
            </Button>
            <Button
              className={styles.botaoMenu}
              onClick={() => {
            ...
            >
              <p className="tormenta20Font">Adquira Tormenta20</p>
            </Button>
            <Button className={styles.botaoMenu}>
              <p className="tormenta20Font">Sair</p>
            </Button>
          </div>
        ...
        <ModalModular
          ...
          footer={
            <>
              ...
              >
                <Button className={btnStyles.botaoFooterModal}>
                  <p className="tormenta20Font">Criar personagem</p>
                </Button>
                <ModalModular
                  placement="center"
              ...
              <Button
                className={btnStyles.botaoFooterModal}
                onClick={() => {
                  if (personagemSelecionado) {
              ...
              >
                <p className="tormenta20Font">Selecionar personagem</p>
              </Button>
            </>
          }
          sidebar={
